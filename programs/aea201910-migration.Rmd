...
Alternatively, we have created a linkage file, available at [`r file.path(git.base,git.repo,git.base,"data","generated","table.aea.icpsr.mapping.csv")`](`r file.path(git.base,git.repo,"data","generated","table.aea.icpsr.mapping.csv")`), containing the article DOI, the title of the paper, and the supplement DOI at openICPSR:
