...
ggsave("figure_files_by_year.png",fig.count_by_year)
ggsave("figure_doi_by_year.png",fig.doi_count_by_year)
...
ggsave("figure_files_count.png",fig.count)
...
ggsave("figure_software_files.png",fig.software.files)
...
ggsave("figure_software_pkgs.png",fig.software.pkgs)

g.software <- ggarrange(fig.software.files,fig.software.pkgs) 
ggsave("figure_software.png",g.software)
...
ggsave("figure_software_years_count.png",fig.software_by_year.count)
...
ggsave("figure_software_years_pct.png",fig.software_by_year.pct)

g.software.years <- ggarrange(fig.software_by_year.count,fig.software_by_year.pct) 
ggsave("figure_software_years.png",g.software.years)
...
The input data to this paper are available at (OPENICPSR TBD). The tables presented in this paper, and the data underlying the figures, are available at [`r file.path(git.base,git.repo,"data","generated")`](`r file.path(git.base,git.repo,"data","generated")`). 
